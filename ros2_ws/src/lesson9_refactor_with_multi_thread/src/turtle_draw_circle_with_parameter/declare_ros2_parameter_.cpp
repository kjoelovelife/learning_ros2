...
void TurtleDrawCircleWithParameter::declare_ros2_parameter_(std::string parameter_name, double& variable){
    ...
    variable = this->get_parameter(parameter_name).as_double();
